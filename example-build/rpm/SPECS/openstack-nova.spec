...
BuildRequires:    python-routes >= 1.12.3, python-routes < 2.0, python-routes > 2.0
...
Requires:         python-neutronclient >= 2.3.6, python-neutronclient < 3.0.0
Requires:         python-novaclient
Requires:         python-oslo-config >= 1.4.0.0
...
Requires:         python-websockify >= 0.6.0, python-websockify < 0.7
